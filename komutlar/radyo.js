...
const radio = {
    ...
    "sonmeztv": "http://162.244.80.30:8122",
            ...
            if (!msg.guild.voiceConnection) {
                ...
                if (!msg.member.voiceChannel) return msg.channel.send('❎ | Lütfen  **sesli bir odaya gir!**')
    ...
    require('http').get(radio[args], (res) => {
     ...
     let embed = new Discord.RichEmbed()
        .setAuthor("Radyo çalıyor...", `https://images-ext-1.discordapp.net/external/0O8M-0Q93aKVqx6tonQInp6W7QRDjlLkH1E6mHMaCeM/%3Fv%3D1/https/cdn.discordapp.com/emojis/475822981277286400.gif`)
        .addField("Çalan Radyo:", args)
		.addField("Kapatmak İçin: **/ayrıl**",)
  ...
  if (msg.content.startsWith('kapat')) {
